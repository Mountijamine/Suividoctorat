...
@Component({
  ...
  .checkbox { display:flex; flex-direction:row; align-items:center; gap:0.5rem; margin-top:0.25rem; width:100%; justify-content:flex-start; text-align:left; white-space:nowrap }
  .checkbox-row { width:100%; overflow:hidden; display:flex; justify-content:flex-start }
  .checkbox input[type="checkbox"] { width:18px; height:18px; flex:0 0 auto }
  .checkbox-text { margin-left:0.25rem }
  .checkbox a { margin-left:0.25rem; color:#2563eb; text-decoration:underline; flex:0 0 auto }
